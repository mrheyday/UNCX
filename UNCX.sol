...
contract UNCX is ERC20("UniCrypt", "UNCX"), Ownable, ERC20Burnable {
    using SafeMath for uint256;
    constructor () {
    uint256 totalSupply = 50000 * 10 ** decimals(); // 50k Total supply, no minting functions
    ...
    */
        ...
        external
    {
        ...
        require(block.timestamp <= expiry, "UNCX::delegateBySig: signature expired");
